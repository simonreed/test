...
description: 'MinimalDocs gives you complete control over the look and feel of your documentation using the docs.json file'
icon: 'gear'
---

Every MinimalDocs site needs a `docs.json` file with the core configuration settings. Learn more about the [properties](#properties) below.
...
<ResponseField name="footerSocials" type="FooterSocials">
  ...
  ```json
  {
    "x": "https://x.com/minimaldocs",
    "website": "https://minimaldocs.com"
  }
  ```
