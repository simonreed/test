...
<AccordionGroup>
  <Accordion icon="copy" title="Clone your docs locally">
    During the onboarding process, you created a GitHub repository with your docs content if you didn't already have one. You can find a link to this repository in your [dashboard](https://dashboard.minimaldocs.com).
  ...
  <Accordion icon="rectangle-terminal" title="Start the preview server">
    1. Install the MinimalDocs CLI: `npm i -g minimaldocs`
    2. Navigate to your docs directory and run: `minimaldocs dev`
...
<AccordionGroup>
  <Accordion icon="github" title="Connect your GitHub repo">
    Connect your GitHub repository from your [dashboard](https://dashboard.minimaldocs.com).
...
<Note>
  **Need help?** See our [full documentation](https://minimaldocs.com/docs) or email us at [hello@minimaldocs.com](mailto:hello@minimaldocs.com).
</Note>
